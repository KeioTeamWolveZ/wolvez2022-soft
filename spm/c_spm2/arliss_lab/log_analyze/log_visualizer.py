...
# plt.scatter(csv_data["timestamp"]-csv_data["timestamp"][0],csv_data["r_w2"],s=2,label="win_2")
# plt.scatter(csv_data["timestamp"]-csv_data["timestamp"][0],csv_data["r_w3"],s=2,label="win_3")
plt.scatter(csv_data["timestamp"]-csv_data["timestamp"][0],csv_data["th_w1"],s=2,label="thre win_1")
plt.scatter(csv_data["timestamp"]-csv_data["timestamp"][0],csv_data["th_w2"],s=2,label="thre win_2")
plt.scatter(csv_data["timestamp"]-csv_data["timestamp"][0],csv_data["th_w3"],s=2,label="thre win_3")
plt.title("risk")
plt.xlabel("time [s]")
plt.ylabel("risk")
plt.legend()
plt.savefig("/Users/hayashidekazuyuki/Desktop/Git_Win_Air/wolvez2022/spm/c_spm2/arliss_lab/log_analyze/results/result_08_risk_thre_アンコール.png",dpi=3000)
plt.cla()