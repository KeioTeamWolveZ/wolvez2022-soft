...
for csv_path in csv_paths:
    ...
    # plt.plot(np.arange(0,len(csv_data_master[6])),threshold_nd,label="threshold_risk (estimated)",lw=4)
    # plt.plot(np.arange(0,len(csv_data_master[6])),csv_data_master[6],label="threshold_risk (estimated)",lw=4)
    # plt.plot(np.arange(0,len(csv_data_master[7])),csv_data_master[7],label="max_risk (estimated)",lw=4)
